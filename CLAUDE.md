...
**All mayor process — rules, drift-unparking, anti-patterns — lives in the `mayor` Claude skill.** That skill is the authoritative source. This section is the minimum stub for non-mayor workers; if the two disagree, the skill wins.
